...
| [`L1-dcache-stores:u`](workers/cpu10/event-0011.log) | 405 | Non-deterministic |
...
| [`assists.any:u`](workers/cpu20/event-0163.log) | 118 | Non-deterministic |
| [`assists.page_fault:u`](workers/cpu12/event-0155.log) | 9 | Non-deterministic |
...
| [`br_misp_retired.ret:u`](workers/cpu37/event-0180.log) | 336 | Non-deterministic |
...
| [`dTLB-stores:u`](workers/cpu14/event-0015.log) | 300 | Non-deterministic |
...
| [`l2_rqsts.swpf_miss:u`](workers/cpu51/event-0052.log) | 19 | Non-deterministic |
...
| [`load_hit_prefetch.swpf:u`](workers/cpu16/event-0230.log) | 26 | Non-deterministic |
...
| [`machine_clears.smc:u`](workers/cpu21/event-0235.log) | 6 | Non-deterministic |
| [`mem-loads-aux:u`](workers/cpu19/event-0020.log) | 2 | Non-deterministic |
| [`mem-stores:u`](workers/cpu20/event-0021.log) | 548 | Non-deterministic |
| [`mem_inst_retired.all_loads:u`](workers/cpu55/event-0056.log) | 2 | Non-deterministic |
| [`mem_inst_retired.all_stores:u`](workers/cpu56/event-0057.log) | 249 | Non-deterministic |
| [`mem_inst_retired.any:u`](workers/cpu57/event-0058.log) | 2 | Non-deterministic |
| [`mem_inst_retired.split_loads:u`](workers/cpu59/event-0060.log) | 3 | Non-deterministic |
| [`mem_inst_retired.split_stores:u`](workers/cpu60/event-0061.log) | 3 | Non-deterministic |
| [`mem_inst_retired.stlb_miss_loads:u`](workers/cpu61/event-0062.log) | 3 | Non-deterministic |
...
| [`mem_load_l3_hit_retired.xsnp_fwd:u`](workers/cpu64/event-0065.log) | 85 | Non-deterministic |
...
| [`mem_load_l3_hit_retired.xsnp_no_fwd:u`](workers/cpu66/event-0067.log) | 1000 | Zero-only |
...
| [`mem_load_l3_miss_retired.remote_hitm:u`](workers/cpu0/event-0072.log) | 1000 | Zero-only |
