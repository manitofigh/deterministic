...
|---|---:|---|
| [`assists.fp:u`](workers/cpu4/event-0068.log) | 10 | Potentially deterministic |
| [`br_inst_retired.cond:u`](workers/cpu21/event-0148.log) | 10 | Potentially deterministic |
| [`br_inst_retired.cond_ntaken:u`](workers/cpu22/event-0149.log) | 10 | Potentially deterministic |
| [`br_inst_retired.cond_taken:u`](workers/cpu23/event-0150.log) | 10 | Potentially deterministic |
| [`br_inst_retired.indirect:u`](workers/cpu25/event-0152.log) | 10 | Potentially deterministic |
| [`br_inst_retired.near_call:u`](workers/cpu26/event-0153.log) | 10 | Potentially deterministic |
| [`br_inst_retired.near_return:u`](workers/cpu27/event-0154.log) | 10 | Potentially deterministic |
| [`br_inst_retired.near_taken:u`](workers/cpu28/event-0155.log) | 10 | Potentially deterministic |
| [`dtlb-stores:u`](workers/cpu43/event-0107.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.128b_packed_double:u`](workers/cpu5/event-0069.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.128b_packed_single:u`](workers/cpu6/event-0070.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.4_flops:u`](workers/cpu9/event-0073.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.scalar:u`](workers/cpu13/event-0077.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.scalar_double:u`](workers/cpu14/event-0078.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.scalar_single:u`](workers/cpu15/event-0079.log) | 10 | Potentially deterministic |
| [`fp_arith_inst_retired.vector:u`](workers/cpu16/event-0080.log) | 10 | Potentially deterministic |
| [`inst_retired.nop:u`](workers/cpu60/event-0187.log) | 10 | Potentially deterministic |
| [`l1-dcache-stores:u`](workers/cpu47/event-0111.log) | 10 | Potentially deterministic |
| [`mem-stores:u`](workers/cpu0/event-0001.log) | 10 | Potentially deterministic |
| [`mem_inst_retired.all_stores:u`](workers/cpu35/event-0036.log) | 10 | Potentially deterministic |
| [`mem_inst_retired.lock_loads:u`](workers/cpu37/event-0038.log) | 10 | Potentially deterministic |
| [`mem_inst_retired.stlb_miss_stores:u`](workers/cpu41/event-0042.log) | 10 | Potentially deterministic |
| [`misc_retired.pause_inst:u`](workers/cpu14/event-0204.log) | 10 | Potentially deterministic |
...
| [`assists.any:u`](workers/cpu19/event-0146.log) | 2 | Non-deterministic |
...
| [`br_misp_retired.cond_ntaken:u`](workers/cpu31/event-0158.log) | 3 | Non-deterministic |
| [`br_misp_retired.cond_taken:u`](workers/cpu32/event-0159.log) | 2 | Non-deterministic |
| [`br_misp_retired.indirect:u`](workers/cpu33/event-0160.log) | 7 | Non-deterministic |
| [`br_misp_retired.indirect_call:u`](workers/cpu34/event-0161.log) | 3 | Non-deterministic |
...
| [`dtlb-store-misses:u`](workers/cpu42/event-0106.log) | 2 | Non-deterministic |
...
| [`dtlb_load_misses.walk_completed:u`](workers/cpu49/event-0239.log) | 2 | Non-deterministic |
| [`dtlb_load_misses.walk_completed_4k:u`](workers/cpu52/event-0242.log) | 2 | Non-deterministic |
...
| [`itlb_misses.stlb_hit:u`](workers/cpu61/event-0251.log) | 3 | Non-deterministic |
...
| [`l2_rqsts.swpf_miss:u`](workers/cpu30/event-0031.log) | 2 | Non-deterministic |
...
| [`load_hit_prefetch.swpf:u`](workers/cpu7/event-0197.log) | 5 | Non-deterministic |
...
| [`mem_inst_retired.split_loads:u`](workers/cpu38/event-0039.log) | 3 | Non-deterministic |
| [`mem_inst_retired.split_stores:u`](workers/cpu39/event-0040.log) | 2 | Non-deterministic |
| [`mem_inst_retired.stlb_miss_loads:u`](workers/cpu40/event-0041.log) | 5 | Non-deterministic |
...
| [`sw_prefetch_access.t0:u`](workers/cpu2/event-0066.log) | 4 | Non-deterministic |
...
| Event | Runs | Determinism |
|---|---:|---|
| [`br_misp_retired.ret:u`](workers/cpu36/event-0163.log) | 10 | Zero-only |
| [`core_power.lvl1_turbo_license:u`](workers/cpu15/event-0142.log) | 10 | Zero-only |
| [`core_power.lvl2_turbo_license:u`](workers/cpu16/event-0143.log) | 10 | Zero-only |
| [`core_snoop_response.s_fwd_m:u`](workers/cpu7/event-0008.log) | 10 | Zero-only |
| [`dtlb_load_misses.walk_completed_1g:u`](workers/cpu50/event-0240.log) | 10 | Zero-only |
| [`dtlb_load_misses.walk_completed_2m_4m:u`](workers/cpu51/event-0241.log) | 10 | Zero-only |
| [`dtlb_store_misses.walk_completed_1g:u`](workers/cpu57/event-0247.log) | 10 | Zero-only |
| [`dtlb_store_misses.walk_completed_2m_4m:u`](workers/cpu58/event-0248.log) | 10 | Zero-only |
| [`fp_arith_inst_retired.256b_packed_double:u`](workers/cpu7/event-0071.log) | 10 | Zero-only |
| [`fp_arith_inst_retired.256b_packed_single:u`](workers/cpu8/event-0072.log) | 10 | Zero-only |
| [`fp_arith_inst_retired.512b_packed_double:u`](workers/cpu10/event-0074.log) | 10 | Zero-only |
| [`fp_arith_inst_retired.512b_packed_single:u`](workers/cpu11/event-0075.log) | 10 | Zero-only |
| [`fp_arith_inst_retired.8_flops:u`](workers/cpu12/event-0076.log) | 10 | Zero-only |
| [`itlb_misses.walk_completed_2m_4m:u`](workers/cpu1/event-0254.log) | 10 | Zero-only |
| [`l2_rqsts.swpf_hit:u`](workers/cpu29/event-0030.log) | 10 | Zero-only |
| [`ld_blocks.no_sr:u`](workers/cpu4/event-0194.log) | 10 | Zero-only |
| [`lsd.cycles_active:u`](workers/cpu8/event-0198.log) | 10 | Zero-only |
| [`lsd.cycles_ok:u`](workers/cpu9/event-0199.log) | 10 | Zero-only |
| [`lsd.uops:u`](workers/cpu10/event-0200.log) | 10 | Zero-only |
| [`mem_load_l3_hit_retired.xsnp_fwd:u`](workers/cpu42/event-0043.log) | 10 | Zero-only |
| [`mem_load_l3_hit_retired.xsnp_miss:u`](workers/cpu43/event-0044.log) | 10 | Zero-only |
| [`mem_load_l3_hit_retired.xsnp_no_fwd:u`](workers/cpu44/event-0045.log) | 10 | Zero-only |
| [`mem_load_l3_miss_retired.remote_dram:u`](workers/cpu47/event-0048.log) | 10 | Zero-only |
| [`mem_load_l3_miss_retired.remote_fwd:u`](workers/cpu48/event-0049.log) | 10 | Zero-only |
| [`mem_load_l3_miss_retired.remote_hitm:u`](workers/cpu49/event-0050.log) | 10 | Zero-only |
| [`mem_load_l3_miss_retired.remote_pmm:u`](workers/cpu50/event-0051.log) | 10 | Zero-only |
| [`mem_load_misc_retired.uc:u`](workers/cpu51/event-0052.log) | 10 | Zero-only |
| [`mem_load_retired.local_pmm:u`](workers/cpu59/event-0060.log) | 10 | Zero-only |
| [`misc_retired.lbr_inserts:u`](workers/cpu13/event-0203.log) | 10 | Zero-only |
| [`rtm_retired.aborted:u`](workers/cpu2/event-0129.log) | 10 | Zero-only |
| [`rtm_retired.aborted_events:u`](workers/cpu3/event-0130.log) | 10 | Zero-only |
| [`rtm_retired.aborted_mem:u`](workers/cpu4/event-0131.log) | 10 | Zero-only |
| [`rtm_retired.aborted_memtype:u`](workers/cpu5/event-0132.log) | 10 | Zero-only |
| [`rtm_retired.aborted_unfriendly:u`](workers/cpu6/event-0133.log) | 10 | Zero-only |
| [`rtm_retired.commit:u`](workers/cpu7/event-0134.log) | 10 | Zero-only |
| [`rtm_retired.start:u`](workers/cpu8/event-0135.log) | 10 | Zero-only |
| [`sq_misc.bus_lock:u`](workers/cpu60/event-0061.log) | 10 | Zero-only |
| [`sq_misc.sq_full:u`](workers/cpu61/event-0062.log) | 10 | Zero-only |
| [`sw_prefetch_access.prefetchw:u`](workers/cpu1/event-0065.log) | 10 | Zero-only |
| [`tx_exec.misc2:u`](workers/cpu9/event-0136.log) | 10 | Zero-only |
| [`tx_exec.misc3:u`](workers/cpu10/event-0137.log) | 10 | Zero-only |
| [`tx_mem.abort_capacity_read:u`](workers/cpu11/event-0138.log) | 10 | Zero-only |
| [`tx_mem.abort_capacity_write:u`](workers/cpu12/event-0139.log) | 10 | Zero-only |
| [`tx_mem.abort_conflict:u`](workers/cpu13/event-0140.log) | 10 | Zero-only |
| [`uops_issued.vector_width_mismatch:u`](workers/cpu43/event-0233.log) | 10 | Zero-only |
