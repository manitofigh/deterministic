...
Complete: 303/303 (100.0%); remaining: 0; elapsed: 176s
Error: 12; Non-deterministic: 197; Potentially deterministic: 24; Zero-only: 70
...
| [`br_misp_exec.indirect:u`](workers/cpu11/event-0183.log) | 5 | Potentially deterministic |
...
| [`itlb_misses.walk_completed_4k:u`](workers/cpu4/event-0290.log) | 5 | Potentially deterministic |
...
| [`br_inst_retired.all_branches:u`](workers/cpu1/event-0173.log) | 3 | Non-deterministic |
...
| [`br_misp_retired.near_call:u`](workers/cpu14/event-0186.log) | 4 | Non-deterministic |
...
| [`machine_clears.memory_ordering:u`](workers/cpu3/event-0137.log) | 3 | Non-deterministic |
...
| Event | Runs | Determinism |
|---|---:|---|
| [`L1-dcache-load-misses:u`](workers/cpu7/event-0293.log) | 1 | Error |
| [`L1-dcache-loads:u`](workers/cpu6/event-0292.log) | 1 | Error |
| [`L1-dcache-stores:u`](workers/cpu8/event-0294.log) | 1 | Error |
| [`L1-icache-load-misses:u`](workers/cpu9/event-0295.log) | 1 | Error |
| [`branch-load-misses:u`](workers/cpu17/event-0303.log) | 1 | Error |
| [`branch-loads:u`](workers/cpu16/event-0302.log) | 1 | Error |
| [`dTLB-load-misses:u`](workers/cpu11/event-0297.log) | 1 | Error |
| [`dTLB-loads:u`](workers/cpu10/event-0296.log) | 1 | Error |
| [`dTLB-store-misses:u`](workers/cpu13/event-0299.log) | 1 | Error |
| [`dTLB-stores:u`](workers/cpu12/event-0298.log) | 1 | Error |
| [`iTLB-load-misses:u`](workers/cpu15/event-0301.log) | 1 | Error |
| [`iTLB-loads:u`](workers/cpu14/event-0300.log) | 1 | Error |
