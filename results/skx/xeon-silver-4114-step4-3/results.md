...
|---|---:|---|
| [`br_inst_retired.cond:u`](workers/cpu2/event-0174.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.cond_ntaken:u`](workers/cpu3/event-0175.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.conditional:u`](workers/cpu4/event-0176.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.near_call:u`](workers/cpu6/event-0178.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.near_return:u`](workers/cpu7/event-0179.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.near_taken:u`](workers/cpu8/event-0180.log) | 1000 | Potentially deterministic |
| [`br_inst_retired.not_taken:u`](workers/cpu9/event-0181.log) | 1000 | Potentially deterministic |
| [`fp_arith_inst_retired.128b_packed_double:u`](workers/cpu7/event-0084.log) | 1000 | Potentially deterministic |
| [`fp_arith_inst_retired.128b_packed_single:u`](workers/cpu8/event-0085.log) | 1000 | Potentially deterministic |
| [`fp_arith_inst_retired.4_flops:u`](workers/cpu11/event-0088.log) | 1000 | Potentially deterministic |
...
| [`inst_retired.nop:u`](workers/cpu7/event-0217.log) | 1000 | Potentially deterministic |
...
| [`L1-dcache-stores:u`](workers/cpu8/event-0294.log) | 73 | Non-deterministic |
...
| [`br_misp_exec.indirect:u`](workers/cpu11/event-0183.log) | 11 | Non-deterministic |
...
| [`br_misp_retired.near_call:u`](workers/cpu14/event-0186.log) | 7 | Non-deterministic |
...
| [`branch-loads:u`](workers/cpu16/event-0302.log) | 3 | Non-deterministic |
...
| [`core_snoop_response.rsp_shitfse:u`](workers/cpu15/event-0168.log) | 3 | Non-deterministic |
...
| [`dTLB-loads:u`](workers/cpu10/event-0296.log) | 3 | Non-deterministic |
| [`dTLB-store-misses:u`](workers/cpu13/event-0299.log) | 2 | Non-deterministic |
| [`dTLB-stores:u`](workers/cpu12/event-0298.log) | 26 | Non-deterministic |
...
| [`dtlb_load_misses.walk_completed:u`](workers/cpu4/event-0271.log) | 4 | Non-deterministic |
...
| [`dtlb_store_misses.walk_completed_4k:u`](workers/cpu15/event-0282.log) | 2 | Non-deterministic |
...
| [`itlb_misses.miss_causes_a_walk:u`](workers/cpu17/event-0284.log) | 4 | Non-deterministic |
...
| [`itlb_misses.walk_completed_4k:u`](workers/cpu4/event-0290.log) | 2 | Non-deterministic |
...
| [`ld_blocks.no_sr:u`](workers/cpu12/event-0222.log) | 2 | Non-deterministic |
...
| [`mem-stores:u`](workers/cpu14/event-0015.log) | 83 | Non-deterministic |
| [`mem_inst_retired.all_loads:u`](workers/cpu16/event-0055.log) | 2 | Non-deterministic |
| [`mem_inst_retired.all_stores:u`](workers/cpu17/event-0056.log) | 99 | Non-deterministic |
...
| [`mem_inst_retired.stlb_miss_stores:u`](workers/cpu4/event-0062.log) | 4 | Non-deterministic |
...
| [`other_assists.any:u`](workers/cpu3/event-0232.log) | 73 | Non-deterministic |
...
| Event | Runs | Determinism |
|---|---:|---|
| [`br_misp_retired.ret:u`](workers/cpu16/event-0188.log) | 1000 | Zero-only |
| [`core_power.lvl1_turbo_license:u`](workers/cpu6/event-0159.log) | 1000 | Zero-only |
| [`core_power.lvl2_turbo_license:u`](workers/cpu7/event-0160.log) | 1000 | Zero-only |
| [`core_power.throttle:u`](workers/cpu8/event-0161.log) | 1000 | Zero-only |
| [`cycles-ct:u`](workers/cpu6/event-0007.log) | 1000 | Zero-only |
| [`cycles-t:u`](workers/cpu7/event-0008.log) | 1000 | Zero-only |
| [`dtlb_load_misses.walk_completed_1g:u`](workers/cpu5/event-0272.log) | 1000 | Zero-only |
| [`dtlb_load_misses.walk_completed_2m_4m:u`](workers/cpu6/event-0273.log) | 1000 | Zero-only |
| [`dtlb_store_misses.walk_completed_1g:u`](workers/cpu13/event-0280.log) | 1000 | Zero-only |
| [`dtlb_store_misses.walk_completed_2m_4m:u`](workers/cpu14/event-0281.log) | 1000 | Zero-only |
...
| [`fp_arith_inst_retired.256b_packed_single:u`](workers/cpu10/event-0087.log) | 1000 | Zero-only |
| [`fp_arith_inst_retired.512b_packed_double:u`](workers/cpu12/event-0089.log) | 1000 | Zero-only |
...
| [`hle_retired.aborted_unfriendly:u`](workers/cpu0/event-0134.log) | 1000 | Zero-only |
| [`hle_retired.commit:u`](workers/cpu1/event-0135.log) | 1000 | Zero-only |
| [`hle_retired.start:u`](workers/cpu2/event-0136.log) | 1000 | Zero-only |
| [`itlb_misses.walk_completed_1g:u`](workers/cpu2/event-0288.log) | 1000 | Zero-only |
| [`itlb_misses.walk_completed_2m_4m:u`](workers/cpu3/event-0289.log) | 1000 | Zero-only |
| [`lsd.cycles_4_uops:u`](workers/cpu16/event-0226.log) | 1000 | Zero-only |
| [`lsd.cycles_active:u`](workers/cpu17/event-0227.log) | 1000 | Zero-only |
| [`lsd.cycles_ok:u`](workers/cpu18/event-0228.log) | 1000 | Zero-only |
| [`lsd.uops:u`](workers/cpu0/event-0229.log) | 1000 | Zero-only |
...
| [`rob_misc_events.pause_inst:u`](workers/cpu7/event-0236.log) | 1000 | Zero-only |
| [`rtm_retired.aborted:u`](workers/cpu4/event-0138.log) | 1000 | Zero-only |
| [`rtm_retired.aborted_events:u`](workers/cpu5/event-0139.log) | 1000 | Zero-only |
| [`rtm_retired.aborted_mem:u`](workers/cpu6/event-0140.log) | 1000 | Zero-only |
| [`rtm_retired.aborted_memtype:u`](workers/cpu7/event-0141.log) | 1000 | Zero-only |
| [`rtm_retired.aborted_timer:u`](workers/cpu8/event-0142.log) | 1000 | Zero-only |
| [`rtm_retired.aborted_unfriendly:u`](workers/cpu9/event-0143.log) | 1000 | Zero-only |
| [`rtm_retired.commit:u`](workers/cpu10/event-0144.log) | 1000 | Zero-only |
| [`rtm_retired.start:u`](workers/cpu11/event-0145.log) | 1000 | Zero-only |
...
| [`tx_exec.misc1:u`](workers/cpu12/event-0146.log) | 1000 | Zero-only |
| [`tx_exec.misc2:u`](workers/cpu13/event-0147.log) | 1000 | Zero-only |
| [`tx_exec.misc3:u`](workers/cpu14/event-0148.log) | 1000 | Zero-only |
| [`tx_exec.misc4:u`](workers/cpu15/event-0149.log) | 1000 | Zero-only |
| [`tx_exec.misc5:u`](workers/cpu16/event-0150.log) | 1000 | Zero-only |
| [`tx_mem.abort_capacity:u`](workers/cpu17/event-0151.log) | 1000 | Zero-only |
| [`tx_mem.abort_conflict:u`](workers/cpu18/event-0152.log) | 1000 | Zero-only |
| [`tx_mem.abort_hle_elision_buffer_mismatch:u`](workers/cpu0/event-0153.log) | 1000 | Zero-only |
| [`tx_mem.abort_hle_elision_buffer_not_empty:u`](workers/cpu1/event-0154.log) | 1000 | Zero-only |
| [`tx_mem.abort_hle_elision_buffer_unsupported_alignment:u`](workers/cpu2/event-0155.log) | 1000 | Zero-only |
| [`tx_mem.abort_hle_store_to_elided_lock:u`](workers/cpu3/event-0156.log) | 1000 | Zero-only |
| [`tx_mem.hle_elision_buffer_full:u`](workers/cpu4/event-0157.log) | 1000 | Zero-only |
| [`uops_issued.vector_width_mismatch:u`](workers/cpu15/event-0263.log) | 1000 | Zero-only |
