...
Migration: original folder `results/skid/skx/xeon-silver-4114-step4-2`. The dated folder uses the previous `profile.md` modification time (2026-09-20T14:27:40-04:00); the original experiment start time was not recorded. The folder time was advanced by 1 second to preserve run order and avoid a collision.
